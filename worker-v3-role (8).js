...
//   SFL_API_KEY           -> (opsional) API key sfl.gl kamu, buat nge-shrink tiap
//                             link gateway /getkey. Kalau kosong/API gagal, link
//                             mentah (gak di-shrink) dipakai sebagai fallback.
//
// KV Binding yang dibutuhkan (Settings -> Bindings):
//   LICENSES
//
// CATATAN PENTING soal SFL_API_KEY:
//   Format panggilan API sfl.gl di bawah ("https://sfl.gl/api?api=KEY&url=URL
//   &format=text") adalah format UMUM yang dipakai kebanyakan situs short-link
//   sejenis. Belum ada dokumentasi resmi sfl.gl yang aku pastikan sama persis -
//   cek dashboard/API doc sfl.gl kamu dan sesuaikan shrinkWithSfl() kalau beda.
// ============================================================
...
// Progress bar teks sederhana, misal buildProgressBar(2,5) -> "●●○○○ (2/5)"
